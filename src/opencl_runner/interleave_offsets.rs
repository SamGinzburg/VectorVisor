...
impl Interleave {
    pub fn read_u8(buffer: &[u8], offset: u32, num_threads: u32, vm_id: u32) -> u8 {
    ...
    pub fn read_u16(buffer: &[u8], offset: u32, num_threads: u32, vm_id: u32) -> u16 {
        let mut temp: u16 = 0;
    ...
    pub fn read_u32(buffer: &[u8], offset: u32, num_threads: u32, vm_id: u32) -> u32 {
        let mut temp: u32 = 0;
        temp += Interleave::read_u16(buffer, offset+2, num_threads, vm_id) as u32;
        temp = temp << 16;
        temp += Interleave::read_u16(buffer, offset, num_threads, vm_id) as u32;
        temp
    }

    pub fn read_u64(buffer: &[u8], offset: u32, num_threads: u32, vm_id: u32) -> u64 {
        let mut temp: u64 = 0;
