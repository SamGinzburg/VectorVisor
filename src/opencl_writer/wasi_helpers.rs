...
pub fn emit_fd_write_helpers(writer: &opencl_writer::OpenCLCWriter, _debug: bool) -> String {
    ...
    result += &String::from("\nvoid fd_write_helper(global uint *stack_u32, global uint* heap_u32, global uint *hypercall_buffer, global ulong *sp, uint warp_idx, uint fd_write_buf_len, uint iovec_count, uint iovec, uint fd) {\n");
...
pub fn emit_fd_write_call_helper(_writer: &opencl_writer::OpenCLCWriter, stack_ctx: &mut StackCtx, _debug: bool) -> String {
    ...
    format!("\t{}\n",
              format!("fd_write_helper({}, {}, {}, {}, {}, {}, {}, {}, {});",
                        ...
                        "hypercall_buffer",
                        "sp",
                        "warp_idx", buf_len, iovec_count, iovec_ptr, fd))
}
