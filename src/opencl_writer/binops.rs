...
pub fn emit_f64_add(writer: &opencl_writer::OpenCLCWriter, debug: bool) -> String {
...
pub fn emit_f64_ne(writer: &opencl_writer::OpenCLCWriter, debug: bool) -> String {
    let mut ret_str = String::from("");
...
pub fn emit_f64_div(writer: &opencl_writer::OpenCLCWriter, debug: bool) -> String {
    let mut ret_str = String::from("");
...
pub fn emit_f64_mul(writer: &opencl_writer::OpenCLCWriter, debug: bool) -> String {
    let mut ret_str = String::from("");
...
pub fn emit_i64_div_s(writer: &opencl_writer::OpenCLCWriter, debug: bool) -> String {
    format!("\t{};\n\t{}\n",
            &emit_write_u64("(ulong)(stack_u32+*sp-4)",
                            "(ulong)(stack_u32)",
                            &format!("(long)({}) / (long)({})",
...
pub fn emit_i32_div_s(writer: &opencl_writer::OpenCLCWriter, debug: bool) -> String {
    format!("\t{};\n\t{}\n",
            &emit_write_u32("(ulong)(stack_u32+*sp-2)",
                            "(ulong)(stack_u32)",
                            &format!("(int)({}) / (int)({})",
...
pub fn emit_i32_rem_u(writer: &opencl_writer::OpenCLCWriter, debug: bool) -> String {
    format!("\t{};\n\t{}\n",
            &emit_write_u32("(ulong)(stack_u32+*sp-2)",
                            "(ulong)(stack_u32)",
                            &format!("(uint)({}) % (uint)({})",
...
pub fn emit_i64_rem_u(writer: &opencl_writer::OpenCLCWriter, debug: bool) -> String {
    format!("\t{};\n\t{}\n",
            &emit_write_u64("(ulong)(stack_u32+*sp-4)",
                            "(ulong)(stack_u32)",
                            &format!("(ulong)({}) % (ulong)({})",
...
pub fn emit_i32_rem_s(writer: &opencl_writer::OpenCLCWriter, debug: bool) -> String {
    format!("\t{};\n\t{}\n",
            &emit_write_u32("(ulong)(stack_u32+*sp-2)",
                            "(ulong)(stack_u32)",
                            &format!("(int)({}) % (int)({})",
...
pub fn emit_i64_rem_s(writer: &opencl_writer::OpenCLCWriter, debug: bool) -> String {
    format!("\t{};\n\t{}\n",
            &emit_write_u64("(ulong)(stack_u32+*sp-4)",
                            "(ulong)(stack_u32)",
                            &format!("(long)({}) % (long)({})",
...
pub fn emit_f64_eq(writer: &opencl_writer::OpenCLCWriter, debug: bool) -> String {
    format!("\t{};\n\t{}\n",
            &emit_write_u32("(ulong)(stack_u32+*sp-4)",
                            "(ulong)(stack_u32)",
