    ...
    match interleave {
        ...
        8 => {
            ...
            result += &format!("\t{}\n",
                               "ulong cell_offset = (addr-mem_start) % 8;");
            result += &format!("\t{}\n",
                               "ulong val1 = (ulong)*((global ulong*)write_addr);");
            result += &format!("\t{}\n",
                               "ulong val2 = (ulong)*((global ulong*)write_addr+(NUM_THREADS));");
            result += &format!("\t{}\n",
                               "ulong combined_vec[2] = { 0 };");
            result += &format!("\t{}\n",
                               "combined_vec[0] = val1;");
            result += &format!("\t{}\n",
                               "combined_vec[1] = val2;");
    ...
    match interleave {
        ...
        8 => {
            ...
            result += &format!("\t{}\n",
                               "uchar *tmp = &tmp_vec;");
            result += &format!("\t{}\n",
                               "ulong val1 = (ulong)*((global ulong*)read_addr);");
            result += &format!("\t{}\n",
                               "ulong val2 = (ulong)*((global ulong*)read_addr+(NUM_THREADS));");
            result += &format!("\t{}\n",
                               "ulong combined_vec[2] = { 0 };");
            result += &format!("\t{}\n",
                               "combined_vec[0] = val1;");
