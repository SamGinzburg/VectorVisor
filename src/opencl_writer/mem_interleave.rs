        ...
        false => {
            result += &format!(
                ...
                &emit_write_u8(
                    "(ulong)(mem_start_dst+dst+counter)",
                    "(ulong)(mem_start_dst)",
                    &emit_read_u8("(ulong)(mem_start_src+src+counter)", "(ulong)(mem_start_src)", "warp_id"),
                    "warp_id"
                )
            );
        }
    ...
    if !fill {
        ...
        result += &format!(
            ...
            &emit_write_u8(
                ...
                "(ulong)(mem_start_dst)",
                &emit_read_u8("(ulong)(mem_start_src+src+buf_len_bytes)", "(ulong)(mem_start_src)", "warp_id"),
                "warp_id"
            )
        );
        result += &format!("\t\t{}\n", "}");
