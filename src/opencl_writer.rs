...
impl<'a> OpenCLCWriter<'_> {
    ...
    fn emit_instructions(
        ...
        match instr {
            ...
            Instruction::V128Load8Lane(load_or_store_lane) => emit_memload_u128_load8_lane(self, stack_ctx, load_or_store_lane, debug),
            ...
            Instruction::I32x4ShrU => vec_x_by_y_binop(self, stack_ctx, VecBinOp::ShrU, VecOpType::Int32, debug),
            ...
            Instruction::F64x2ExtractLane(laneval) => extract_lane(self, stack_ctx, StackType::f64, laneval.lane, debug),
