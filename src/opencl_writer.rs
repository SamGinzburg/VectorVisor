...
impl<'a> OpenCLCWriter<'_> {
    ...
    fn emit_instructions(
        ...
        match instr {
            ...
            wast::Instruction::I32Load(memarg) => emit_memload_i32(self, stack_ctx, memarg, debug),
            ...
            wast::Instruction::I64Load8s(memarg) => {
            ...
            wast::Instruction::I64Load(memarg) => emit_memload_i64(self, stack_ctx, memarg, debug),
            wast::Instruction::F64Load(memarg) => emit_memload_f64(self, stack_ctx, memarg, debug),
            wast::Instruction::F32Load(memarg) => emit_memload_f32(self, stack_ctx, memarg, debug),
		...
		emit_memfill(self, stack_ctx, memarg, debug)
            ...
            wast::Instruction::GlobalGet(idx) => match idx {
                ...
                wast::Index::Num(value, _) => emit_global_get(
                    self,
                    stack_ctx,
                    &format!("g{}", value),
                    global_mappings,
            ...
            wast::Instruction::GlobalSet(idx) => match idx {
                wast::Index::Id(id) => {
                    emit_global_set(self, stack_ctx, id.name(), global_mappings, debug)
                }
                wast::Index::Num(value, _) => emit_global_set(
                    self,
                    stack_ctx,
                    &format!("g{}", value),
                    global_mappings,
            ...
            wast::Instruction::I32Const(val) => emit_i32_const(self, stack_ctx, val, debug),
            ...
            wast::Instruction::LocalSet(idx) => match idx {
                wast::Index::Id(id) => emit_local_set(
                    self,
                    stack_ctx,
                    parameter_offset,
                    id.name(),
            ...
            wast::Instruction::LocalTee(idx) => match idx {
                wast::Index::Id(id) => emit_local_tee(
                    self,
                    stack_ctx,
                    parameter_offset,
                    id.name(),
             ...
             */
            wast::Instruction::I32Add => emit_i32_add(self, stack_ctx, debug),
            wast::Instruction::I32Mul => emit_i32_mul(self, stack_ctx, debug),
            wast::Instruction::I64Mul => emit_i64_mul(self, stack_ctx, debug),
            wast::Instruction::I32Sub => emit_i32_sub(self, stack_ctx, debug),
            wast::Instruction::I64Add => emit_i64_add(self, stack_ctx, debug),
            wast::Instruction::F32Trunc => emit_f32_trunc(self, stack_ctx, debug),
            wast::Instruction::F64Trunc => emit_f64_trunc(self, stack_ctx, debug),
            wast::Instruction::F64Add => emit_f64_add(self, stack_ctx, debug),
            wast::Instruction::F64Max => emit_f64_max(self, stack_ctx, debug),
            wast::Instruction::F64Min => emit_f64_min(self, stack_ctx, debug),
            wast::Instruction::F32Max => emit_f32_max(self, stack_ctx, debug),
            wast::Instruction::F32Min => emit_f32_min(self, stack_ctx, debug),
            wast::Instruction::F64Sub => emit_f64_sub(self, stack_ctx, debug),
            wast::Instruction::F32Add => emit_f32_add(self, stack_ctx, debug),
            wast::Instruction::F32Sub => emit_f32_sub(self, stack_ctx, debug),
            wast::Instruction::F32Mul => emit_f32_mul(self, stack_ctx, debug),
            wast::Instruction::F64Div => emit_f64_div(self, stack_ctx, debug),
            wast::Instruction::F32Div => emit_f32_div(self, stack_ctx, debug),
            wast::Instruction::F64Mul => emit_f64_mul(self, stack_ctx, debug),
            wast::Instruction::F64Neg => emit_f64_neg(self, stack_ctx, debug),
            wast::Instruction::F32Neg => emit_f32_neg(self, stack_ctx, debug),
            wast::Instruction::F32Abs => emit_f32_abs(self, stack_ctx, debug),
            wast::Instruction::F64Abs => emit_f64_abs(self, stack_ctx, debug),
            wast::Instruction::F64Sqrt => emit_f64_sqrt(self, stack_ctx, debug),
            wast::Instruction::F32Sqrt => emit_f32_sqrt(self, stack_ctx, debug),
            wast::Instruction::F64Ne => emit_f64_ne(self, stack_ctx, debug),
            wast::Instruction::F32Ne => emit_f32_ne(self, stack_ctx, debug),
            wast::Instruction::F64Lt => emit_f64_lt(self, stack_ctx, debug),
            wast::Instruction::F32Gt => emit_f32_gt(self, stack_ctx, debug),
            wast::Instruction::F32Lt => emit_f32_lt(self, stack_ctx, debug),
            wast::Instruction::F64Le => emit_f64_le(self, stack_ctx, debug),
            wast::Instruction::F64Ge => emit_f64_ge(self, stack_ctx, debug),
            wast::Instruction::F64Gt => emit_f64_gt(self, stack_ctx, debug),
            wast::Instruction::F32Le => emit_f32_le(self, stack_ctx, debug),
            wast::Instruction::F32Ge => emit_f32_ge(self, stack_ctx, debug),
            wast::Instruction::I64LtU => emit_i64_lt_u(self, stack_ctx, debug),
            wast::Instruction::I64Eq => emit_i64_eq(self, stack_ctx, debug),
            wast::Instruction::F64Eq => emit_f64_eq(self, stack_ctx, debug),
            wast::Instruction::F32Eq => emit_f32_eq(self, stack_ctx, debug),
            wast::Instruction::I32TruncF64U => emit_i32_trunc_f64_u(self, stack_ctx, debug),
            wast::Instruction::I64TruncF64U => emit_i64_trunc_f64_u(self, stack_ctx, debug),
            wast::Instruction::I64Ne => emit_i64_ne(self, stack_ctx, debug),
            wast::Instruction::I64DivU => emit_i64_div_u(self, stack_ctx, debug),
            wast::Instruction::I32Eqz => emit_i32_eqz(self, stack_ctx, debug),
            wast::Instruction::I64Eqz => emit_i64_eqz(self, stack_ctx, debug),
            wast::Instruction::I32And => emit_i32_and(self, stack_ctx, debug),
            wast::Instruction::I64And => emit_i64_and(self, stack_ctx, debug),
            wast::Instruction::I32Ne => emit_i32_ne(self, stack_ctx, debug),
            wast::Instruction::I32LtU => emit_i32_lt_u(self, stack_ctx, debug),
            wast::Instruction::I32LtS => emit_i32_lt_s(self, stack_ctx, debug),
            wast::Instruction::I64LtS => emit_i64_lt_s(self, stack_ctx, debug),
            wast::Instruction::I32GtU => emit_i32_gt_u(self, stack_ctx, debug),
            wast::Instruction::I64GtU => emit_i64_gt_u(self, stack_ctx, debug),
            wast::Instruction::I64GtS => emit_i64_gt_s(self, stack_ctx, debug),
            wast::Instruction::I32GtS => emit_i32_gt_s(self, stack_ctx, debug),
            wast::Instruction::I32LeU => emit_i32_le_u(self, stack_ctx, debug),
            wast::Instruction::I32LeS => emit_i32_le_s(self, stack_ctx, debug),
            wast::Instruction::I64LeU => emit_i64_le_u(self, stack_ctx, debug),
            wast::Instruction::I64LeS => emit_i64_le_s(self, stack_ctx, debug),
            wast::Instruction::I32GeU => emit_i32_ge_u(self, stack_ctx, debug),
            wast::Instruction::I32GeS => emit_i32_ge_s(self, stack_ctx, debug),
            wast::Instruction::I64GeU => emit_i64_ge_u(self, stack_ctx, debug),
            wast::Instruction::I64GeS => emit_i64_ge_s(self, stack_ctx, debug),
            wast::Instruction::I32Xor => emit_i32_xor(self, stack_ctx, debug),
            wast::Instruction::I32WrapI64 => emit_i32_wrap_i64(self, stack_ctx, debug),
            wast::Instruction::I64ExtendI32S => emit_i64_extend_i32_s(self, stack_ctx, debug),
            wast::Instruction::I64ExtendI32U => emit_i64_extend_i32_u(self, stack_ctx, debug),
            ...
            wast::Instruction::I32Eq => emit_i32_eq(self, stack_ctx, debug),
            wast::Instruction::I32Or => emit_i32_or(self, stack_ctx, debug),
            wast::Instruction::I32ShrU => emit_i32_shr_u(self, stack_ctx, debug),
            wast::Instruction::I64ShrU => emit_i64_shr_u(self, stack_ctx, debug),
            wast::Instruction::I32ShrS => emit_i32_shr_s(self, stack_ctx, debug),
            wast::Instruction::I32Shl => emit_i32_shl(self, stack_ctx, debug),
            wast::Instruction::I64Shl => emit_i64_shl(self, stack_ctx, debug),
            wast::Instruction::I32DivU => emit_i32_div_u(self, stack_ctx, debug),
            wast::Instruction::I32DivS => emit_i32_div_s(self, stack_ctx, debug),
            wast::Instruction::I64DivS => emit_i64_div_s(self, stack_ctx, debug),
            wast::Instruction::I32RemU => emit_i32_rem_u(self, stack_ctx, debug),
            wast::Instruction::I64RemU => emit_i64_rem_u(self, stack_ctx, debug),
            wast::Instruction::I32RemS => emit_i32_rem_s(self, stack_ctx, debug),
            wast::Instruction::I64RemS => emit_i64_rem_s(self, stack_ctx, debug),
            wast::Instruction::I64ShrS => emit_i64_shr_s(self, stack_ctx, debug),
            wast::Instruction::I64Xor => emit_i64_xor(self, stack_ctx, debug),
            wast::Instruction::I64Or => emit_i64_or(self, stack_ctx, debug),
            wast::Instruction::I32Rotl => emit_i32_rotl(self, stack_ctx, debug),
            wast::Instruction::I64Rotl => emit_i64_rotl(self, stack_ctx, debug),
            wast::Instruction::I64Sub => emit_i64_sub(self, stack_ctx, debug),
            ...
            wast::Instruction::F64Ceil => emit_f64_ceil(self, stack_ctx, debug),
            wast::Instruction::F32Ceil => emit_f32_ceil(self, stack_ctx, debug),
            wast::Instruction::F64Floor => emit_f64_floor(self, stack_ctx, debug),
            wast::Instruction::F32Floor => emit_f32_floor(self, stack_ctx, debug),
            wast::Instruction::F64PromoteF32 => emit_f64_promote_f32(self, stack_ctx, debug),
            wast::Instruction::F32DemoteF64 => emit_f32_demote_f64(self, stack_ctx, debug),
            wast::Instruction::F64ConvertI32S => emit_f64_convert_i32(self, stack_ctx, debug),
            wast::Instruction::F64ConvertI32U => emit_f64_convert_i32u(self, stack_ctx, debug),
            wast::Instruction::F32ConvertI32U => emit_f32_convert_i32u(self, stack_ctx, debug),
            wast::Instruction::F32ConvertI64U => emit_f32_convert_i64u(self, stack_ctx, debug),
            wast::Instruction::F32ConvertI32S => emit_f32_convert_i32s(self, stack_ctx, debug),
            wast::Instruction::F64ConvertI64U => emit_f64_convert_i64u(self, stack_ctx, debug),
            wast::Instruction::F64ConvertI64S => emit_f64_convert_i64s(self, stack_ctx, debug),
            wast::Instruction::I32TruncF32U => emit_i32_trunc_f32_u(self, stack_ctx, debug),
            wast::Instruction::I64TruncF32U => emit_i64_trunc_f32_u(self, stack_ctx, debug),
            wast::Instruction::I64TruncF32S => emit_i64_trunc_f32_s(self, stack_ctx, debug),
            wast::Instruction::I32TruncF32S => emit_i32_trunc_f32_s(self, stack_ctx, debug),
            wast::Instruction::I64TruncF64S => emit_i64_trunc_f64_s(self, stack_ctx, debug),
            wast::Instruction::I32TruncF64S => emit_i32_trunc_f64_s(self, stack_ctx, debug),
            wast::Instruction::I32Clz => emit_i32_clz(self, stack_ctx, debug),
            wast::Instruction::I32Popcnt => emit_i32_popcnt(self, stack_ctx, debug),
            wast::Instruction::I64Clz => emit_i64_clz(self, stack_ctx, debug),
            wast::Instruction::I32Ctz => emit_i32_ctz(self, stack_ctx, debug),
            wast::Instruction::I64Ctz => emit_i64_ctz(self, stack_ctx, debug),
            ...
            wast::Instruction::Select(_) => emit_select(self, stack_ctx, fn_name, debug),
            wast::Instruction::MemoryGrow(arg) => emit_mem_grow(self, stack_ctx, arg, debug),
            wast::Instruction::MemorySize(arg) => emit_mem_size(self, stack_ctx, arg, debug),
            wast::Instruction::Return => emit_return(
                self,
                stack_ctx,
                fn_name,
                start_function_name,
            ...
            wast::Instruction::Br(idx) => emit_br(
                self,
                stack_ctx,
                *idx,
                fn_name,
            ...
            wast::Instruction::BrIf(idx) => emit_br_if(
                self,
                stack_ctx,
                *idx,
                fn_name,
            ...
            wast::Instruction::BrTable(table_idxs) => emit_br_table(
                self,
                stack_ctx,
                table_idxs,
                fn_name,
    ...
    fn emit_global_init(
        ...
        for global in &self.globals {
            ...
            match &global.kind {
                wast::GlobalKind::Inline(expr) => match &expr.instrs[0] {
                    wast::Instruction::I32Const(val) => {
                        ret_str += &format!(
                            "\t{};\n",
                            &emit_write_u32(
...
__attribute__((always_inline)) void {}(global uint   *stack_u32,
    ...
    fn generate_data_section(
        ...
        let (program_start_mem_pages, program_start_max_pages) = match self.memory.get(0) {
            Some(mem) => match mem.kind {
                wast::MemoryKind::Normal(memtype) => match memtype {
	...
	emit_volatile_reads_writes: bool,
        ...
        let start_func = match start_fn_name_tmp {
            Some(wast::ExportKind::Func(wast::Index::Id(id))) => format_fn_name(id.name()),
