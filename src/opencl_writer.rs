...
impl<'a> OpenCLCWriter<'_> {
    pub fn new(pb: &'a ParseBuffer, patch_buffer: &'a ParseBuffer, is_pretty_input: bool) -> OpenCLCWriter<'a> {
        OpenCLCWriter {
            types: HashMap::new(),
                    ...
                    match item {
                        ...
                        wast::ModuleField::Import(i) => {
                            match i.clone().item.id {
                                Some(id) => {
                                    self.imports_map.insert(format_fn_name(id.name()), (i.module, i.field, i.item));
                                },
                                None => {
...
__attribute__((always_inline)) void {}(global uint   *stack_u32,
    ...
    pub fn write_opencl_file(&mut self,
                             hcall_buf_size: u32,
                             interleave: u32,
                             stack_size_bytes: u32,
                             heap_size_bytes: u32,
