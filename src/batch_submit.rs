...
impl BatchSubmitServer {
    ...
    fn create_response(resp: bytes::Bytes, on_dev_time: u64, queue_submit_time: u64, num_queue_submits: u64, num_unique_fns: u64, queue_time: u128, device_time: u128) -> warp::http::Response<Body> {
