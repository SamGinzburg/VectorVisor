...
function nlpscript() {
  cargo run --release -- -i $1-opt-4-profile.wasm --heap=$2 --stack=$3 --hcallsize=$4 --vmcount=$6 --partition=false --maxdup=0 --jt=true --interleave=4 --uw=true --pinput=$7 &> /vv/$1-opt-4-profile.log
  cargo run --release -- -i $1-opt-8-profile.wasm --heap=$2 --stack=$3 --hcallsize=$4 --vmcount=$6 --partition=false --maxdup=0 --jt=true --interleave=8 --uw=true --pinput=$7 &> /vv/$1-opt-8-profile.log
}
...
nlpscript "nlp-assemblyscript" "3145728" "131072" "8192" "4096" "6144" "false"
nlpscript "nlp-go" "3145728" "131072" "8192" "4096" "6144" "true"
