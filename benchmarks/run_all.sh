...
STARTTIME=$(date +%s)
python3 run_benchmarks_aws.py --gpu=amd --cpu=amd --interleave=4 --dir=$v520_dir_4_profile --skip-cpu True --ami=$1 --cpuami=$2 --run-profile True --skip-membench=True --awsarn=$4 & 
python3 run_benchmarks_aws.py --gpu=amd --cpu=intel --interleave=8 --dir=$v520_dir_8_profile --skip-cpu True --ami=$1 --cpuami=$2 --run-profile True --skip-membench=True --awsarn=$4 & 
...
TOTAL_START_TIME=$(date +%s)
STARTTIME=$(date +%s)
python3 run_benchmarks_aws.py --awsarn=$4 --gpu=amd --cpu=amd --interleave=4 --dir=$v520_dir_4_breakdown --skip-cpu True --ami=$1 --cpuami=$2 --run-profile True --breakdown=True --skip-membench=True & 
python3 run_benchmarks_aws.py --awsarn=$4 --gpu=amd --cpu=intel --interleave=8 --dir=$v520_dir_8_breakdown --skip-cpu True --ami=$1 --cpuami=$2 --run-profile True --breakdown=True --skip-membench=True & 
for job in `jobs -p`; do wait ${job}; done
ENDTIME=$(date +%s)
...
TOTAL_START_TIME=$(date +%s)
STARTTIME=$(date +%s)
python3 run_benchmarks_aws.py --awsarn=$4 --gpu=amd --cpu=amd --interleave=4 --dir=$amd_membench --skip-cpu True --ami=$1 --cpuami=$2 --membench=True
for job in `jobs -p`; do wait ${job}; done
ENDTIME=$(date +%s)
