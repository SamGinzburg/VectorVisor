...
STARTTIME=$(date +%s)
python3 run_benchmarks_aws.py --gpu=t4 --cpu=amd --interleave=4 --dir=$t4_dir_4 --skip-membench True --ami=$1 & 
#python3 run_benchmarks_aws.py --gpu=a10g --cpu=intel --interleave=4 --dir=$a10g_dir_4 --skip-membench True &
