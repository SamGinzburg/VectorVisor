...
STARTTIME=$(date +%s)
python3 run_benchmarks_aws.py --gpu=t4 --cpu=amd --interleave=4 --dir=$t4_dir_4 & 
python3 run_benchmarks_aws.py --gpu=a10g --cpu=intel --interleave=4 --dir=$a10g_dir_4 &
...
STARTTIME=$(date +%s)
python3 run_benchmarks_aws.py --gpu=t4 --cpu=amd --interleave=8 --dir=$t4_dir_8 --skip-membench & 
python3 run_benchmarks_aws.py --gpu=a10g --cpu=intel --interleave=8 --dir=$a10g_dir_8 --skip-membench &
for job in `jobs -p`; do wait ${job}; done
ENDTIME=$(date +%s)
